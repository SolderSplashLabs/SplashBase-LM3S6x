...
#define SSI_INDEX_R1NAME        49
#define SSI_INDEX_R2NAME        50
#define SSI_INDEX_R3NAME        51
#define SSI_INDEX_R4NAME        52
...
static const char *g_pcConfigSSITags[] =
{
    ...
    "relay1",	  // SSI_INDEX_R1NAME
    "relay2",	  // SSI_INDEX_R2NAME
    "relay3",	  // SSI_INDEX_R3NAME
    "relay4"	  // SSI_INDEX_R4NAME
};
#endif
...
//! values are 0 and 1.
//!
//! This function changes the serial and  configuration to match the
    ...
    switch(iIndex)
    {
        ...
        case SSI_INDEX_REVISION:
        {
            return(usnprintf(pcInsert, iInsertLen, "%d.%d",
            		SW_REV_MAJOR, SW_REV_MINOR));
        }

        case SSI_INDEX_R1NAME :
        {
        	return(usnprintf(pcInsert, iInsertLen, "%s", g_sParameters.relayOneName ));
        }

		case SSI_INDEX_R2NAME :
		{
			return(usnprintf(pcInsert, iInsertLen, "%s", g_sParameters.relayTwoName ));
		}

		case SSI_INDEX_R3NAME :
		{
			return(usnprintf(pcInsert, iInsertLen, "%s", g_sParameters.relayThreeName ));
		}

		case SSI_INDEX_R4NAME :
		{
			return(usnprintf(pcInsert, iInsertLen, "%s", g_sParameters.relayFourName ));
		}
